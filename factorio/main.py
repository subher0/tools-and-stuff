...
def launch():
    ...
    central_manager.request_rate(red_science, 5, 'root')
    central_manager.request_rate(green_science, 5, 'root')
    central_manager.request_rate(gray_science, 5, 'root')
    central_manager.request_rate(blue_science, 5, 'root')
    central_manager.request_rate(purple_science, 5, 'root')
    central_manager.request_rate(yellow_science, 5, 'root')
    central_manager.request_rate(space_science, 5, 'root')
